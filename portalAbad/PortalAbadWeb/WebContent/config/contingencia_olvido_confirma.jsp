		...
		<div class="col-md-10">
			...
			<div class="panel panel-default"> 
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-md-10">Resumen de la confirmación de la firma del cambio de clave de acceso</div>
					...
					<div id="alerta" class="alert alert-success alert-dismissible" role="alert">
						<p id="alertaMsg"> </p>
						<div class="col-md-11"><img src="images/danger.png">&emsp;<span id="alertaMsg">El cambio de contraseña se ha realizado correctamente</span></div>
						<div class="col-md-1" style="padding-top: 2px;"><a href="#" onclick="cerrarAlerta('#alerta')"><img src="images/cerrarAlerta.png"></a></div>
						<br>
					</div>
					<%}
					...
					{%>
					<div id="alerta" class="alert alert-danger alert-dismissible" role="alert">
						<div class="col-md-11"><img src="images/danger.png">&emsp;<span id="alertaMsg">Error al modificar la clave de acceso, inténtelo de nuevo</span></div>
						<div class="col-md-1" style="padding-top: 2px;"><a href="#" onclick="cerrarAlerta('#alerta')"><img src="images/cerrarAlerta.png"></a></div>
						<br>
					</div>
					<%}%>
